...
@Slf4j
@Singleton
class ATemporossOverlay extends OverlayPanel
{
	private final ATemporossPlugin plugin;
	private final ATemporossConfiguration config;

	String timeFormat;
	private String infoStatus = "Starting...";

	@Inject
	private ATemporossOverlay(final Client client, final ATemporossPlugin plugin, final ATemporossConfiguration config)
	{
		super(plugin);
	...
	{
		if (plugin.botTimer == null || !plugin.startBarbarianFisher || !config.enableUI())
		{

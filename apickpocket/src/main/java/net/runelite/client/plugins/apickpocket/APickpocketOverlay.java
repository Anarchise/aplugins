...
@Slf4j
@Singleton
class APickpocketOverlay extends OverlayPanel
{
	private final APickpocketPlugin plugin;
	private final APickpocketConfig config;

	String timeFormat;
	private String infoStatus = "Starting...";

	@Inject
	private APickpocketOverlay(final Client client, final APickpocketPlugin plugin, final APickpocketConfig config)
	{
		super(plugin);

...
@Slf4j
@Singleton
class AFighterOverlay extends OverlayPanel
{
	private final AFighterPlugin plugin;
	private final AFighterConfig config;

	String timeFormat;
	private String infoStatus = "Starting...";

	@Inject
	private AFighterOverlay(final Client client, final AFighterPlugin plugin, final AFighterConfig config)
	{
		super(plugin);
